...
class ONNXInfer:
    def __init__(self, args):
        ...
        # self.faiss_index = faiss.GpuIndexFlatIP(res, args.features_dim)
...
def resize_crop_center(image, crop_width, crop_height):
    
    # Step 1: 缩放图像到 562x450
    resized_img = cv2.resize(image, (562, 450), interpolation=cv2.INTER_LINEAR)
    x_offset = (562 - 512) // 2

    tmp = resized_img[:,  x_offset:x_offset+512]
    ...
    # 填充图像
    new_img[y_offset:y_offset+450, :] = tmp
...
if __name__ == '__main__':
    ...
    # basic params
    parser.add_argument('--model_path', type=str, default= "/media/bh/xujg/UAV-VisionLoc/src/uvl2.onnx", help='model path, could be .pt or .rknn file')
    ...
    parser.add_argument('--save_path1', default="/media/bh/xujg/UAV-VisionLoc/result_sample3_positive", help='save the result')
    parser.add_argument('--save_path2', default="/media/bh/xujg/UAV-VisionLoc/result_sample3_negative", help='save the result')
    # data params
    parser.add_argument('--img_folder', type=str, default='/media/bh/xujg/UAV-VisionLoc/data/dataset_undistort/test_exp31', help='img folder path')
    parser.add_argument('--path_local_database', type=str, default='/media/bh/xujg/UAV-VisionLoc/data/database_array_1113.h5', help='load local features and utms of database')
    ...
    for i in tqdm(range(len(img_list))):
        ...
        if args.img_show or args.img_save:
            ...
            if args.get_base:
                base_img_path = "/media/bh/xujg/UAV-VisionLoc/data/dataset_undistort/test_database.h5"
