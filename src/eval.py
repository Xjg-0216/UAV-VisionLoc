...
test_ds = datasets_ws.BaseDataset(
    args, args.datasets_folder, args.dataset_name, "test", che=1)
...
if args.separate_branch:
    ...
    recalls, recalls_str = test.test(args, test_ds, model, model_db = model, test_method = args.test_method, pca = pca, visualize=args.visual_all)
